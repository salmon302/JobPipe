# Scoring Optimizations Final - 2026-05-15
...
- Added government/legislative domain detection
- Better penalization of government/legislative jobs.

### 9. **Early Recency Filter** ✅
- Moved recency check to the beginning of the loop
- Old jobs rejected immediately, before any scoring computation.
...
- `src/jobpipe/pipeline.py` - Relevance boost, old job filter, domain penalty, early recency filter
